...
# Notes:  = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == = == 
#	This is the setup for the intra-household model (IHM).
...
def generatePopulationsAndNorms(agentNumber):
	...
	thetaFile = pd.read_csv("initialTransfer.csv")

	i = 0
	for agentIndex in range(0, agentNumber, 2):
		bob = generateAgent(agentIndex, agentIndex, preferencesFile["male"][i], conformityFile["male"][i], thetaFile["x"][i], totalTime)
		alice = generateAgent(agentIndex + 1, agentIndex, preferencesFile["female"][i], conformityFile["female"][i], thetaFile["x"][i], totalTime)
...
thetaMin, thetaMax, thetaStep = -1, 1, 0.025
convergenceLoops = 10
